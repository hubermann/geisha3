controller_dashboard = "<!DOCTYPE html>
<html lang=\"en\">
  <head>
    <meta charset=\"utf-8\">
    <title></title>
...
file_controller_dashboard = File.new("../application/views/control/login.php", "w+")
if file_controller_dashboard
   file_controller_dashboard.syswrite(controller_dashboard)
else
